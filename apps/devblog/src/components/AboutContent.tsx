    ...
    <main className="flex-1 mx-auto px-6 py-16 max-w-[52rem] w-full">
      ...
      <section className="mb-8 space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
        <p>
          ...
          여깁니다. 개발할 때는 구조와 재사용성을 고려해 지속 가능한 코드를
          설계하려 노력합니다. 문제를 정확히 이해하고, 상황에 가장 알맞은 기술로
          풀어내는 것을 중요하게 생각합니다. 예상대로 동작하는 코드에 안주하지
          않고, 사용자 관점에서 더 나은 경험을 만들기 위해 끊임없이 개선합니다.
          맡은 일에 책임감을 가지고 주도적으로 움직이며, 동료와의 소통을 통해 더
          나은 결과를 만들어갑니다. 개발 외에는 식물 키우기와 심리학에 관심이
