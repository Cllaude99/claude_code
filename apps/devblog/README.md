...
Next.js 15, TypeScript, MDX로 구축된 현대적인 개발 블로그입니다.

![DevBlog Screenshot](https://via.placeholder.com/800x400?text=DevBlog+Screenshot)
...
| `category` | | string | 카테고리 (`Tech`, `CS`, `Log` 중 선택) |
